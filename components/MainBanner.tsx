...
const MainBanner = () => {
    ...
    return (
        <section className="flex lg:flex-row md:flex-row flex-col items-center justify-evenly lg:p-2 w-screen bg-background-secondary border-t-neon-yellow border-b-neon-red border-2">
            {!isMobile && <Image src="/images/mmlogo.png" alt="MarketMinder Logo" width={100} height={100} />}
            <div className="flex flex-col items-center justify-evenly">
                ...
                <div className='m-4 flex lg:flex-row md:flex-row flex-col justify-center gap-4'>
                    ...
                    <Button asChild size="lg" disabled={true} variant={"secondary"}>

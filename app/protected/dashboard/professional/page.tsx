...
import { columns, Place, calculateUptime } from "../../../../lib/places";
...
const getPlacesFromData = (data: any) => {
  ...
  for (let i = 0; i < data.places.length; i++) {
    ...
    let place = new Place(
      ...
      false, // Enterprise plan doesn't use business name matching
      openHours,
    );
...
const EnterpriseDash = () => {
  ...
  // Column visibility state for premium data fields
    ...
    if (navigator.geolocation) {
      navigator.geolocation.getCurrentPosition(async (position) => {
        ...
        try {
          ...
          setPlaces(getPlacesFromData(data));

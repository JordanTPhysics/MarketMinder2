  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        "neon-green": "rgba(var(--neon-green))",
        "neon-blue": "rgba(var(--neon-blue))",
        "neon-red": "rgba(var(--neon-red))",
        "neon-yellow": "rgba(var(--neon-yellow))",
        "neon-purple": "rgba(var(--neon-purple))",
        "neon-orange": "rgba(var(--neon-orange))",
        "neon-pink": "rgba(var(--neon-pink))",
        "neon-brown": "rgba(var(--neon-brown))",
      },
      borderRadius: {
        lg: "var(--radius)",
